...
{
    public class DuckECSManager : MonoBehaviour
    {
        [SerializeField]
        ...
        void Awake()
        {
            ...
            _world.EntityManager.SetComponentData(player, new CharacterData() { Speed = 50, RotationalSpeed = 5, BulletEntityTemplate = bulletEntityTemplate });
